...
class DocumentDependencyProvider extends AbstractDependencyProvider
{
    /**
    ...
    public function getDependencies(?array $elements): array
    {
        ...
        foreach ($elements as $element) {
            ...
            $result[$key] = [
                ...
                self::TYPE_KEY => SafeDeleteConstants::TYPE_DOCUMENT,
    ...
    {
        return $elementType === SafeDeleteConstants::TYPE_DOCUMENT;
    }
}
